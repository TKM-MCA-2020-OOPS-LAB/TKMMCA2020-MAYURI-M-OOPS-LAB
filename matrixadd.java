...
public class matrixadd {
	...
	public static matrixadd sum(matrixadd c1, matrixadd c2) {
	int rc, cc;
	matrixadd temp = new matrixadd();
	...
	{
	matrixadd first = new matrixadd();
	matrixadd second = new matrixadd();
	matrixadd temp = sum(first, second);
	first.get_metrix();
	second.get_metrix();
